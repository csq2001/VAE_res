...
$env:VAE_STAGE2_EPOCHS = if ($env:VAE_STAGE2_EPOCHS) { $env:VAE_STAGE2_EPOCHS } else { "25" }
$env:VAE_STAGE3_EPOCHS = if ($env:VAE_STAGE3_EPOCHS) { $env:VAE_STAGE3_EPOCHS } else { "5" }
