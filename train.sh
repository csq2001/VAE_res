...
export VAE_STAGE1_EPOCHS="${VAE_STAGE1_EPOCHS:-0}"
export VAE_STAGE2_EPOCHS="${VAE_STAGE2_EPOCHS:-5}"
export VAE_STAGE3_EPOCHS="${VAE_STAGE3_EPOCHS:-0}"
export VAE_STAGE3_LR_FACTOR="${VAE_STAGE3_LR_FACTOR:-0.05}"
export VAE_BATCH_SIZE="${VAE_BATCH_SIZE:-16}"
export VAE_PATCH_SIZE="${VAE_PATCH_SIZE:-256}"
export VAE_LR="${VAE_LR:-1e-4}"
export VAE_TAU="${VAE_TAU:-5}"
...
export VAE_CHANNELS="${VAE_CHANNELS:-3}"
...
export VAE_CHECKERBOARD_CONTEXT="${VAE_CHECKERBOARD_CONTEXT:-1}"
...
export VAE_RESUME_STAGE1="${VAE_RESUME_STAGE1:-outputs/checkpoints/checkpoint_stage1.pth}"
export VAE_RESUME_STAGE2="${VAE_RESUME_STAGE2:-outputs/checkpoints/best.pth}"
export VAE_RESUME_STAGE3="${VAE_RESUME_STAGE3:-outputs/checkpoints/best.pth}"
